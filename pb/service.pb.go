...
func init() {
	proto.RegisterType((*Greeting)(nil), "user.Greeting")
	proto.RegisterType((*GreetRequest)(nil), "user.GreetRequest")
	proto.RegisterType((*GreetResponse)(nil), "user.GreetResponse")
	proto.RegisterType((*GreetManyTimesRequest)(nil), "user.GreetManyTimesRequest")
	proto.RegisterType((*GreetManyTimesResponse)(nil), "user.GreetManyTimesResponse")
	proto.RegisterType((*LongGreetRequest)(nil), "user.LongGreetRequest")
	proto.RegisterType((*LongGreetResponse)(nil), "user.LongGreetResponse")
	proto.RegisterType((*GreetEveryoneRequest)(nil), "user.GreetEveryoneRequest")
	proto.RegisterType((*GreetEveryoneResponse)(nil), "user.GreetEveryoneResponse")
}
...
var fileDescriptor_6ff5ab49d8a5fcc4 = []byte{
	...
	,
}
...
type DemoServiceClient interface {
	...
	// server streaming
	GreetManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (DemoService_GreetManyTimesClient, error)
	// client streaming
	LongGreet(ctx context.Context, opts ...grpc.CallOption) (DemoService_LongGreetClient, error)
	// bi directional
	GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (DemoService_GreetEveryoneClient, error)
}
...
func (c *demoServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user.DemoService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *demoServiceClient) GreetManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (DemoService_GreetManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DemoService_serviceDesc.Streams[0], "/user.DemoService/GreetManyTimes", opts...)
	if err != nil {
		return nil, err
	}
	x := &demoServiceGreetManyTimesClient{stream}
...
type DemoService_GreetManyTimesClient interface {
	Recv() (*GreetManyTimesResponse, error)
	grpc.ClientStream
}

type demoServiceGreetManyTimesClient struct {
	grpc.ClientStream
}

func (x *demoServiceGreetManyTimesClient) Recv() (*GreetManyTimesResponse, error) {
...
func (c *demoServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (DemoService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DemoService_serviceDesc.Streams[1], "/user.DemoService/LongGreet", opts...)
	if err != nil {
		return nil, err
	}
	x := &demoServiceLongGreetClient{stream}
	return x, nil
}

type DemoService_LongGreetClient interface {
	Send(*LongGreetRequest) error
	CloseAndRecv() (*LongGreetResponse, error)
	grpc.ClientStream
}

type demoServiceLongGreetClient struct {
	grpc.ClientStream
}

func (x *demoServiceLongGreetClient) Send(m *LongGreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *demoServiceLongGreetClient) CloseAndRecv() (*LongGreetResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (c *demoServiceClient) GreetEveryone(ctx context.Context, opts ...grpc.CallOption) (DemoService_GreetEveryoneClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DemoService_serviceDesc.Streams[2], "/user.DemoService/GreetEveryone", opts...)
	if err != nil {
		return nil, err
	}
	x := &demoServiceGreetEveryoneClient{stream}
	return x, nil
}

type DemoService_GreetEveryoneClient interface {
	Send(*GreetEveryoneRequest) error
	Recv() (*GreetEveryoneResponse, error)
	grpc.ClientStream
}

type demoServiceGreetEveryoneClient struct {
	grpc.ClientStream
}

func (x *demoServiceGreetEveryoneClient) Send(m *GreetEveryoneRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *demoServiceGreetEveryoneClient) Recv() (*GreetEveryoneResponse, error) {
...
type DemoServiceServer interface {
	...
	// server streaming
	GreetManyTimes(*GreetManyTimesRequest, DemoService_GreetManyTimesServer) error
	// client streaming
	LongGreet(DemoService_LongGreetServer) error
	// bi directional
	GreetEveryone(DemoService_GreetEveryoneServer) error
}
...
func _DemoService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.DemoService/Greet",
	}
...
func _DemoService_GreetManyTimes_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GreetManyTimesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DemoServiceServer).GreetManyTimes(m, &demoServiceGreetManyTimesServer{stream})
}

type DemoService_GreetManyTimesServer interface {
	Send(*GreetManyTimesResponse) error
	grpc.ServerStream
}

type demoServiceGreetManyTimesServer struct {
	grpc.ServerStream
}

func (x *demoServiceGreetManyTimesServer) Send(m *GreetManyTimesResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _DemoService_LongGreet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DemoServiceServer).LongGreet(&demoServiceLongGreetServer{stream})
}

type DemoService_LongGreetServer interface {
	SendAndClose(*LongGreetResponse) error
	Recv() (*LongGreetRequest, error)
	grpc.ServerStream
}

type demoServiceLongGreetServer struct {
	grpc.ServerStream
}

func (x *demoServiceLongGreetServer) SendAndClose(m *LongGreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *demoServiceLongGreetServer) Recv() (*LongGreetRequest, error) {
...
func _DemoService_GreetEveryone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DemoServiceServer).GreetEveryone(&demoServiceGreetEveryoneServer{stream})
}

type DemoService_GreetEveryoneServer interface {
	Send(*GreetEveryoneResponse) error
	Recv() (*GreetEveryoneRequest, error)
	grpc.ServerStream
}

type demoServiceGreetEveryoneServer struct {
	grpc.ServerStream
}

func (x *demoServiceGreetEveryoneServer) Send(m *GreetEveryoneResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *demoServiceGreetEveryoneServer) Recv() (*GreetEveryoneRequest, error) {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _DemoService_GreetManyTimes_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "LongGreet",
			Handler:       _DemoService_LongGreet_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "GreetEveryone",
			Handler:       _DemoService_GreetEveryone_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
